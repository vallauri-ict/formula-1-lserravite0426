CREATE TABLE [dbo].[Circuits] (
    ...
    [recordLap]  VARCHAR (30)  DEFAULT N'',
    [img]        VARCHAR (512) DEFAULT N'',
    PRIMARY KEY CLUSTERED ([id] ASC),
    FOREIGN KEY ([extCountry]) REFERENCES [dbo].[Countries]([countryCode])
);
...
INSERT INTO [dbo].[Circuits] ([id], [name], [length], [nLaps], [extCountry], [recordLap], [img]) VALUES (16, N'Sochi Autodrom', 5848, 53, N'RU', N'', N'https://media.motorbox.com/image/tutte-le-info-sul-gp-russia-2019-orari-meteo-risultati/6/5/2/652862/652862-16x9-md.jpg');
...
INSERT INTO [dbo].[Circuits] ([id], [name], [length], [nLaps], [extCountry], [recordLap], [img]) VALUES (19, N'Circuit of The Americas', 5513, 56, N'US', N'', N'https://media.motorbox.com/image/tutte-le-info-sul-gp-usa-2019-orari-meteo-risultati/6/5/7/657488/657488-16x9-md.jpg');
INSERT INTO [dbo].[Circuits] ([id], [name], [length], [nLaps], [extCountry], [recordLap], [img]) VALUES (20, N'Autodromo Josè Carlos Pace', 4309, 71, N'BR', N'', N'https://media.motorbox.com/image/tutte-le-info-sul-gp-brasile-2019-orari-meteo-risultati/6/5/8/658839/658839-16x9-md.jpg');
INSERT INTO [dbo].[Circuits] ([id], [name], [length], [nLaps], [extCountry], [recordLap], [img]) VALUES (21, N'Yas Marina Circuit', 5554, 55, N'AE', N'', N'https://media.motorbox.com/image/tutte-le-info-sul-gp-abu-dhabi-2019-orari-meteo-risultati/6/6/0/660478/660478-16x9-md.jpg');
