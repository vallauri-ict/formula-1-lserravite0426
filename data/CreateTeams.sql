CREATE TABLE [dbo].[Teams] (
    ...
    FOREIGN KEY ([extFirstDriver]) REFERENCES [dbo].[Drivers]([id]),
    FOREIGN KEY ([extSecondDriver]) REFERENCES [dbo].[Drivers]([id])
);
